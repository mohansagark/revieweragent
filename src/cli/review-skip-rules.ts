...
// call, no check run on head SHA, exit 0. The generated workflow may drop
// non-PR issue_comment noise with a job-level `if:` (SPEC §9); this is
// still the authoritative check — a job-level `if:` skip is not a safe gate.
